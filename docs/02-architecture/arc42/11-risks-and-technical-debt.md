...
| Externe APIs können ausfallen. | Wetter oder Pokémon-Bilder laden eventuell nicht. | Frontend-Fallbacks halten das Dashboard benutzbar; das Backend nutzt für PokeAPI kurze Timeouts und lokale Starter-Daten. |
