...
| Niedrig    | Legacy-Dokumentation bleibt im Repository.                 | Alte Roadmaptexte koennen Pruefer verwirren.                                                                                                                                      | Legacy-Dateien sind markiert; aktuelle Dokumentation verweist auf Angular und Docker.                                                                         |
