...
Terminalbefehlen versteckt sein.

## Strategische Entscheidungen

Die wichtigsten Architektur- und Technologieentscheidungen wurden bewusst klein,
nachvollziehbar und Projekt angemessen gehalten. Ziel war nicht eine maximal
...
| Qualitätssicherung | Tests, CI, Sonar/Reports                                                     | Qualität wird nicht nur beschrieben, sondern automatisiert ausgeführt und zentral sichtbar gemacht.                                                                                         |
...
für Angular, Spring Boot, REST, PostgreSQL, Docker Compose und die Testpyramide.
