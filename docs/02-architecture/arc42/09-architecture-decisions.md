...
| --- | --- | --- |
| ADR-001 | Spring Boot für das Backend. | Accepted |
| ADR-002 | Angular und TypeScript für das Frontend. | Accepted |
| ADR-003 | PostgreSQL als Persistenzschicht. | Accepted |
| ADR-004 | PokeAPI als externe Datenquelle. | Accepted |
